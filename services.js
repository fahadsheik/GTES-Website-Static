...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.service-section, .deliverable-item, .capability-category, .cta-content');
...
// Capability category hover effects
document.querySelectorAll('.capability-category').forEach(category => {
    category.addEventListener('mouseenter', () => {
        category.style.transform = 'translateY(-10px) rotateY(2deg)';
    });
    
    category.addEventListener('mouseleave', () => {
        category.style.transform = 'translateY(0) rotateY(0)';
    });
});
...
// Add stagger animation to deliverable items
...
// Initialize typing animation for page header
document.addEventListener('DOMContentLoaded', () => {
...
// Add counter animation for any numeric values
